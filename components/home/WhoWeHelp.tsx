        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 mb-16">
          {victims.map((item, i) => (
            <motion.div
              ...
              className="relative bg-[#f8f6f0] border border-[#e8e0cc] rounded-2xl p-7 overflow-hidden"
            >
              {/* Gold top bar */}
              <div className="absolute top-0 left-0 w-full h-1 bg-[#b8960c] rounded-t-2xl" />

              {/* Icon */}
              <div className="w-14 h-14 rounded-xl bg-white border border-[#e8e0cc] flex items-center justify-center mb-5">
                {item.icon}
              </div>
          ...
          <motion.div
            ...
            className="bg-[#0a1628] border border-[#0a1628] rounded-2xl p-7 flex flex-col justify-between"
          >
            <div>
