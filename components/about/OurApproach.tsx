              ...
              >
                ...
                <div className="flex items-start gap-6">
                  ...
                  <div className="shrink-0 flex flex-col items-center gap-2">
                    <span className="font-heading text-4xl font-bold text-white/10 group-hover:text-[#b8960c]/30 transition-colors duration-300 leading-none">
                      {step.number}
                    </span>
                    <div className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center group-hover:bg-[#b8960c]/10 group-hover:border-[#b8960c]/40 transition-all duration-300">
                      {step.icon}
                    </div>
                  </div>
