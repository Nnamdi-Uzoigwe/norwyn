        ...
        {services.map((service, i) => {
          ...
          return (
            <motion.div
              ...
              className={`grid grid-cols-1 lg:grid-cols-2 gap-0 rounded-2xl overflow-hidden border border-[#e8e0cc]`}
            >
              {/* Info panel */}
              ...
              <div className={`bg-[#f8f6f0] p-10 flex flex-col justify-center ${!isEven ? "lg:order-1" : ""}`}>
                ...
                <ul className="space-y-4">
                  {service.items.map((item, j) => (
                    ...
                    >
                      <div className="w-1.5 h-1.5 rounded-full bg-[#b8960c] shrink-0" />
