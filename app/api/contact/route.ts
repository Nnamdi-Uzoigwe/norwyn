...
export async function POST(req: NextRequest) {
  try {
    ...
    const { error } = await resend.emails.send({
      from: "Norwyn Solutions <onboarding@resend.dev>", // 👈 replace with your verified domain later e.g. no-reply@norwyn.com
      ...
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; color: #0a1628;">
          <div style="background: #0a1628; padding: 24px 32px; border-radius: 12px 12px 0 0;">
            <h1 style="color: #b8960c; font-size: 20px; margin: 0;">Norwyn Solutions</h1>
